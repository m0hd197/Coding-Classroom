...
const CourseThirteen = () => {
    return (
        ...
        <div className="right_content" >
                        ...
                        <Link to='../course12' className="previous_page BTN">Previous</Link>
                        <Link to='../' className="next_page BTN">Restart</Link>   
                        </div>
                     </div>
                     </div>
